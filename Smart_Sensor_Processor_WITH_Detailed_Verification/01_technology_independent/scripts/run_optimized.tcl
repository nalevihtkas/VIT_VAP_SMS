...
syn_generic
write_hdl -generic > $ROOT/outputs/optimized/smart_sensor_ti_opt_generic.v
...
write_hdl > $ROOT/outputs/optimized/smart_sensor_ti_opt_netlist.v
write_sdc > $ROOT/outputs/optimized/smart_sensor_ti_opt_sdc.sdc
write_sdf -timescale ns -nonegchecks -recrem split -edges check_edge -setuphold split \
    > $ROOT/outputs/optimized/smart_sensor_ti_opt_delays.sdf
