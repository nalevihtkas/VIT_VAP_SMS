...
# Use ONLY when the architecture genuinely permits 3 cycles.
set_multicycle_path 3 -setup -from [get_pins U_LAUNCH/Q] -to [get_pins U_CAPTURE/D]
set_multicycle_path 2 -hold  -from [get_pins U_LAUNCH/Q] -to [get_pins U_CAPTURE/D]
